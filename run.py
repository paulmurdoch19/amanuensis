...
parser.add_argument(
    ...
    "amanuensis-config.yaml. Will search in defined search folders specified in "
    "amanuensis's settings. To automatically create configs, check out the "
    'cfg_help.py file in this directory. Run "python cfg_help.py --help".',
    default="amanuensis-config.yaml",
)
parser.add_argument(
    "--config_path",
    help="Full path to a yaml config file for amanuensis. Will not"
