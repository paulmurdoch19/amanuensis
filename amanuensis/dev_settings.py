...
PSQLGRAPH = {
    ...
    "database": os.getenv("GDC_PG_DBNAME", "amanuensis_automated_test"),
}

# API server
AMANUENSIS_HOST = os.getenv("AMANUENSIS_HOST", "localhost")
AMANUENSIS_PORT = int(os.getenv("AMANUENSIS_PORT", "5000"))
...
SESSION_COOKIE_NAME = "amanuensis_session"
