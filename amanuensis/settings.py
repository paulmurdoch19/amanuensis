"""
amanuensis Configuration Support Settings
...
# Folders to look in for the *config.yaml for amanuensis
CONFIG_SEARCH_FOLDERS = ["/var/www/amanuensis", "{}/.gen3/amanuensis".format(expanduser("~"))]
...
#
# ``local_settings"" is not installed under the amanuensis module in produdction.
