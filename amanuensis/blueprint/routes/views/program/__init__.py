...
from amanuensis import auth
from amanuensis import dictionary
from amanuensis import models
from amanuensis import utils
from amanuensis.blueprint.routes.views.program import project
from amanuensis.errors import APINotImplemented, AuthError, NotFoundError, UserError
from amanuensis.globals import PERMISSIONS, PROJECT_SEED, ROLES, STATES_COMITTABLE_DRY_RUN
from amanuensis.transactions import upload
from amanuensis.transactions.upload.entity_factory import UploadEntityFactory
from amanuensis.transactions.upload.transaction import UploadTransaction
...
@utils.assert_program_exists
@auth.require_amanuensis_project_admin
