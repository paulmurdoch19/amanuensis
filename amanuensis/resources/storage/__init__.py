...
from amanuensis.errors import NotSupported, InternalError, Unauthorized, NotFound
from amanuensis.resources.google import STORAGE_ACCESS_PROVIDER_NAME as GOOGLE_PROVIDER
...
class StorageManager(object):
    ...
    def _get_storage_user(self, username, provider, session):
        ...
        Depending on the provider, may call to get or just search amanuensis's db.
