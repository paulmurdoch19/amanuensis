...
from amanuensis.auth import current_token, require_auth_header
from amanuensis.restful import RestfulApi
from amanuensis.config import config
from amanuensis.errors import UserError, NotFound, Unauthorized, Forbidden
from amanuensis.resources.google.validity import GoogleProjectValidity
from amanuensis.resources.google.access_utils import (
...
from amanuensis.models import UserServiceAccount
...
class GoogleServiceAccountRoot(Resource):
    ...
    def _post_new_service_account(self, sa):
        ...
        Args:
            sa (
                amanuensis.resources.google.service_account.GoogleServiceAccountRegistration
...
class GoogleServiceAccount(Resource):
    ...
    def _get_monitoring_service_account_response(self):
        ...
        if not monitoring_account_email:
            error = (
                "No monitoring service account. amanuensis is not currently "
    ...
    if (
        ...
        if response["errors"]["service_account_email"].get("status") == 200:
            ...
            response["errors"]["service_account_email"]["error_description"] = (
                "amanuensis's monitoring service account was not found on the project so we "
...
def _get_google_project_id_error_status(validity_info):
    ...
    if not has_access:
        ...
        response["error_description"] = (
            "amanuensis's monitoring service account "
